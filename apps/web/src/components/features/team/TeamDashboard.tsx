...
export function TeamDashboard() {
  ...
  if (!scope) return <div className="mx-auto max-w-xl px-5 py-24 text-center"><span className="mx-auto grid size-14 place-items-center rounded-lg bg-[#b7f34a]/10 text-2xl text-[#b7f34a]">⚙</span><h1 className="mt-5 text-3xl font-semibold text-white">Choose your team first</h1><p className="mt-3 text-sm leading-6 text-[#78847e]">Open settings in the top-right corner, connect a league, and select the team this workspace should use.</p></div>;
