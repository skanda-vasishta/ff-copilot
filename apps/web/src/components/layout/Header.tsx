  ...
  return <header className="app-header sticky top-0 z-30 border-b border-white/[.055] bg-[#0a0b09]/90 backdrop-blur-xl">
    <div className="flex min-h-14 w-full flex-wrap items-center gap-y-2 px-3 py-2 sm:h-14 sm:flex-nowrap sm:px-5 sm:py-0">
      ...
      <div ref={menuRef} className="relative ml-1 sm:order-4">
        ...
        {open && <div role="menu" className="absolute right-0 top-[calc(100%+7px)] w-[min(18rem,calc(100vw-1.5rem))] overflow-hidden rounded-[9px] border border-white/[.09] bg-[#11130f] p-1.5 shadow-[0_20px_60px_rgba(0,0,0,.55)]">
