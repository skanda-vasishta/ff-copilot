...
export function AgentPanel() {
  ...
  return <div className="copilot-shell grid h-full min-h-0 overflow-hidden bg-[#080907] lg:grid-cols-[238px_minmax(0,1fr)]">
    ...
    <section className="flex min-h-0 min-w-0 flex-col">
      <header className="copilot-toolbar flex min-h-[58px] flex-wrap items-center justify-between gap-3 border-b border-white/[.055] bg-[#0a0b09]/60 px-5 py-2 backdrop-blur-xl sm:px-6">
      ...
      <form onSubmit={submit} className="copilot-composer-fade shrink-0 bg-gradient-to-t from-[#080907] via-[#080907]/95 to-transparent px-5 pb-5 pt-2 sm:px-8">
