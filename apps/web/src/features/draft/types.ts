...
export type DraftPlayer = { id: string; name: string; position: string | null; nfl_team: string | null; projected_total_points: number | null; median_rank: number | null; average_rank: number | null; injury_status: string | null }
