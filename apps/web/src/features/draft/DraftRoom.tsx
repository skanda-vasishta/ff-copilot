...
function ActiveDraft({ state, onChanged }: { state: Awaited<ReturnType<typeof getDraftState>>; teams: DraftTeam[]; onChanged: () => void }) {
  ...
  return <div className="flex min-h-0 flex-1 flex-col">
    ...
    <div className="grid min-h-0 flex-1 lg:grid-cols-[minmax(480px,1.25fr)_minmax(420px,.75fr)]">
      <section className="flex min-h-0 flex-col border-r border-white/[.06]"><DraftCopilot key={session.revision} thread={state.thread} season={session.season}/></section>
