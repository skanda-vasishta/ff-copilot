...
export default function RankingsPage() {
  return <div className="mx-auto max-w-[1180px] px-4 py-8 sm:px-6 lg:px-8">
    <div className="mb-[18px] flex flex-col justify-between gap-4 sm:flex-row sm:items-end">
      <div><p className="text-[10px] font-semibold uppercase tracking-[.11em] text-[#9dbe4e]">Player rankings</p><h1 className="mt-1.5 text-[30px] font-semibold tracking-[-.03em] text-[#eef1e9]">Rankings</h1><p className="mt-2 text-[13px] text-[#8a9280]">Consensus rankings, projections, and availability for your selected season.</p></div>
