    ...
    <section className="relative flex min-h-screen items-center justify-center px-5 py-12 sm:px-10">
      <div className="w-full max-w-[420px]">
        ...
        <form onSubmit={submit} className="mt-9 space-y-5">
          ...
          <button disabled={loading} className="focus-ring w-full rounded-md bg-[#b7f34a] px-4 py-3.5 text-sm font-bold text-[#10140a] transition hover:bg-[#c7ff5e] disabled:cursor-wait disabled:opacity-60">{loading ? 'One moment…' : mode === 'login' ? 'Sign in' : 'Create account'}</button>
        </form>
